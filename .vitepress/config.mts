...
export default defineConfig({
  ...
  themeConfig: {
        ...
        },
        {
          ...
          items: [
            { text: "Overview", link: "/api/text/" },
            {
              ...
              collapsed: true,
              items: [
                { text: "Overview", link: "/api/text/string/" },
                { text: "At", link: "/api/text/string/at" },
                { text: "Clone", link: "/api/text/string/clone" },
                { text: "Contains", link: "/api/text/string/contains" },
                { text: "Data", link: "/api/text/string/data" },
                { text: "EndsWith", link: "/api/text/string/endswith" },
                { text: "Equals", link: "/api/text/string/equals" },
                { text: "Free", link: "/api/text/string/free" },
                { text: "From", link: "/api/text/string/from" },
                { text: "IndexOf", link: "/api/text/string/indexof" },
                { text: "IsEmpty", link: "/api/text/string/isempty" },
                { text: "Length", link: "/api/text/string/length" },
                { text: "New", link: "/api/text/string/new" },
                { text: "Repeat", link: "/api/text/string/repeat" },
                { text: "StartsWith", link: "/api/text/string/startswith" },
                { text: "Substring", link: "/api/text/string/substring" },
                { text: "ToLower", link: "/api/text/string/tolower" },
                { text: "ToUpper", link: "/api/text/string/toupper" },
                { text: "Trim", link: "/api/text/string/trim" },
                { text: "+", link: "/api/text/string/plus" },
              ],
            },
            {
              text: "StringBuilder",
              collapsed: true,
              items: [
                { text: "Overview", link: "/api/text/stringbuilder/" },
                { text: "Append", link: "/api/text/stringbuilder/append" },
                {
                  text: "Capacity",
                  link: "/api/text/stringbuilder/capacity",
                },
                { text: "Clear", link: "/api/text/stringbuilder/clear" },
                { text: "Data", link: "/api/text/stringbuilder/data" },
                { text: "Free", link: "/api/text/stringbuilder/free" },
                { text: "Grow", link: "/api/text/stringbuilder/grow" },
                {
                  text: "IntoString",
                  link: "/api/text/stringbuilder/intostring",
                },
                { text: "IsEmpty", link: "/api/text/stringbuilder/isempty" },
                { text: "Length", link: "/api/text/stringbuilder/length" },
                { text: "New", link: "/api/text/stringbuilder/new" },
                { text: "Reserve", link: "/api/text/stringbuilder/reserve" },
                { text: "Shrink", link: "/api/text/stringbuilder/shrink" },
                { text: "ToString", link: "/api/text/stringbuilder/tostring" },
                {
                  text: "WithCapacity",
                  link: "/api/text/stringbuilder/withcapacity",
                },
              ],
            },
            { text: "IsSpace", link: "/api/text/isspace" },
          ],
        },
        {
          text: "BSD",
    ...
    footer: {
      message:
        'Released under the <a href="https://github.com/rux-lang/Rux/blob/main/LICENSE.md">MIT License</a>',
      copyright:
