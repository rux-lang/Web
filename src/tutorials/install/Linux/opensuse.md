...
This guide explains how to install the Rux compiler on OpenSUSE Distros using [Copr](https://copr.fedorainfracloud.org/), a package build service provided by Fedora.
