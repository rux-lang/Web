...
The package is distributed through [Package Control](https://packagecontrol.io). If Package Control is not yet installed, add it via **Tools → Install Package Control…** in Sublime Text.
