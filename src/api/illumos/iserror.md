...
::: danger
This range overlaps legitimate success values. For example, successful small
reads and writes return byte counts in this range, and a valid process ID may
also fall in it. Use the called operation's contract to decide whether
`IsError` is appropriate.
:::
