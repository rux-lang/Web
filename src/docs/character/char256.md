...
let raw = 0x1F600 as char256;  // raw value via explicit cast
```
...
let wide: char512 = raw;       // widening — implicit
```
...
- [`char128`](./char128) — the next width down
- [`char512`](./char512) — the next width up
