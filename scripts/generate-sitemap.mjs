...
const outputCandidates = [resolve(scriptDirectory, "../.output/public"), resolve(scriptDirectory, "../dist")];

try {
  const outputDirectory = await resolvePublicDirectory(outputCandidates);
