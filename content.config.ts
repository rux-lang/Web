 ...
 *
 * The five documentation books (/docs/start/, /docs/lang/, /docs/cli/,
 * /docs/packaging/, /docs/api/) plus /blog/ are slices of ONE tree, which is
 * exactly what queryCollectionNavigation returns. Splitting per section would
 * mean six navigation queries, six search calls and branching in the catch-all
 * page, for no gain.
 *
