...
- [`Sin`](/api/math/sin) / [`Cos`](/api/math/cos) — sine and cosine
- [`Cotan`](/api/math/cotan) — the reciprocal function, computed directly rather than as `1 / Tan(x)`
- [`ArcTan`](/api/math/arctan) — the inverse of `Tan`
