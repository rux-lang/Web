...
- [`Floor`](/api/math/floor) — round down
- [`Ceil`](/api/math/ceil) — round up
- [`Round`](/api/math/round) — round to the nearest integer
- [`Mod`](/api/math/mod) — the remainder built on this truncation
