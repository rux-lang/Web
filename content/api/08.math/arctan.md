...
- [`Tan`](/api/math/tan) — the function `ArcTan` inverts
- [`ArcSin`](/api/math/arcsin) / [`ArcCos`](/api/math/arccos) — the other inverse trigonometric functions
- [`ArcCot`](/api/math/arccot) — `HalfPi - ArcTan(x)`
