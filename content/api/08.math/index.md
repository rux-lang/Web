...
| -------------------------- | --------------------------------------------------- |
| [`Abs`](/api/math/abs)     | Absolute value.                                     |
| [`Min`](/api/math/min)     | The smaller of two values.                          |
| [`Max`](/api/math/max)     | The larger of two values.                           |
| [`Mod`](/api/math/mod)     | Floating-point remainder, signed like the dividend. |
| [`Pow`](/api/math/pow)     | Raise a base to an exponent.                        |
| [`Sqrt`](/api/math/sqrt)   | Square root.                                        |
| [`Cbrt`](/api/math/cbrt)   | Cube root, defined for negative arguments too.      |
| [`Hypot`](/api/math/hypot) | √(x² + y²), without spurious overflow or underflow. |

### Rounding

| Function                   | Description                                        |
| -------------------------- | -------------------------------------------------- |
| [`Floor`](/api/math/floor) | Round down to the nearest integer value.           |
| [`Ceil`](/api/math/ceil)   | Round up to the nearest integer value.             |
| [`Round`](/api/math/round) | Round to the nearest integer, ties away from zero. |
| [`Trunc`](/api/math/trunc) | Round toward zero.                                 |

### Exponential and logarithmic

| Function                   | Description          |
| -------------------------- | -------------------- |
| [`Exp`](/api/math/exp)     | e raised to a power. |
| [`Exp2`](/api/math/exp2)   | 2 raised to a power. |
| [`Log`](/api/math/log)     | Natural logarithm.   |
| [`Log2`](/api/math/log2)   | Base-2 logarithm.    |
...
| Function                     | Description                       |
| ---------------------------- | --------------------------------- |
| [`Sin`](/api/math/sin)       | Sine of an angle in radians.      |
| [`Cos`](/api/math/cos)       | Cosine of an angle in radians.    |
| [`Tan`](/api/math/tan)       | Tangent of an angle in radians.   |
| [`Cotan`](/api/math/cotan)   | Cotangent of an angle in radians. |
| [`ArcSin`](/api/math/arcsin) | Inverse sine, in radians.         |
| [`ArcCos`](/api/math/arccos) | Inverse cosine, in radians.       |
| [`ArcTan`](/api/math/arctan) | Inverse tangent, in radians.      |
| [`ArcCot`](/api/math/arccot) | Inverse cotangent, in radians.    |

### Hyperbolic

| Function                     | Description           |
| ---------------------------- | --------------------- |
| [`Sinh`](/api/math/sinh)     | Hyperbolic sine.      |
| [`Cosh`](/api/math/cosh)     | Hyperbolic cosine.    |
| [`Tanh`](/api/math/tanh)     | Hyperbolic tangent.   |
| [`Cotanh`](/api/math/cotanh) | Hyperbolic cotangent. |

### Angle conversion

| Function                         | Description                 |
| -------------------------------- | --------------------------- |
| [`DegToRad`](/api/math/degtorad) | Convert degrees to radians. |
| [`RadToDeg`](/api/math/radtodeg) | Convert radians to degrees. |
