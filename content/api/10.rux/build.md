...
| `debugAssertions` | `bool`             | Whether [`DebugAssert`](/api/rux/assert) checks are compiled. |
...
- [`#target`](/api/rux/target) / [`#compiler`](/api/rux/compiler) / [`#config`](/api/rux/config) / [`#source`](/api/rux/source) — the other compile-time values
