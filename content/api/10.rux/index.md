...
| Type                        | Description                                      |
| --------------------------- | ------------------------------------------------ |
| [`Result`](/api/rux/result) | The return type of an operation that can fail.   |
| [`Slice`](/api/rux/slice)   | A view over a contiguous sequence of elements.   |
| [`Ranges`](/api/rux/ranges) | The range types produced by the range operators. |
...
| --------------------------- | ---------------------------------------------------- |
| [`Assert`](/api/rux/assert) | Check a condition at run time, aborting if it fails. |
| [`Panic`](/api/rux/panic)   | Terminate the program immediately with a message.    |
| [`#Error`](/api/rux/error)  | Emit a compilation error.                            |
| [`#Warn`](/api/rux/warn)    | Emit a compilation warning.                          |

## Compile-time context

| Value                            | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| [`#target`](/api/rux/target)     | Information about the compilation target.             |
| [`#build`](/api/rux/build)       | Information about the active build.                   |
| [`#compiler`](/api/rux/compiler) | Information about the compiler performing the build.  |
| [`#config`](/api/rux/config)     | User-defined values from the manifest and `--define`. |
| [`#source`](/api/rux/source)     | Location of the expression that reads it.             |
