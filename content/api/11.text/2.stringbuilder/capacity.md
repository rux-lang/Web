...
Capacity only ever grows on its own — [`Clear`](/api/text/stringbuilder/clear) keeps it, and [`Shrink`](/api/text/stringbuilder/shrink) is what hands it back.
...
- [`Length`](/api/text/stringbuilder/length) — how much of the capacity is used
- [`Reserve`](/api/text/stringbuilder/reserve) — ask for more room up front
- [`Shrink`](/api/text/stringbuilder/shrink) — hand back what is unused
