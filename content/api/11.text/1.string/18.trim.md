...
Whitespace is space, tab, newline, and carriage return, which is exactly what [`IsSpace`](/api/text/isspace) reports.
...
- [`IsSpace`](/api/text/isspace) — the bytes this treats as whitespace
- [`Substring`](/api/text/string/substring) — drop bytes from the ends by offset instead
