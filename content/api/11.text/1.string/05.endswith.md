...
The comparison is byte for byte and case-sensitive, on the same terms as [`StartsWith`](/api/text/string/startswith).
...
- [`StartsWith`](/api/text/string/startswith) — the same test at the other end
- [`Contains`](/api/text/string/contains) — look for the bytes anywhere
