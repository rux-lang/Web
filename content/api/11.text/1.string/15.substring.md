...
- [`IndexOf`](/api/text/string/indexof) — find the offset to copy from
- [`At`](/api/text/string/at) — read one byte instead of copying a range
- [`Trim`](/api/text/string/trim) — the common case of dropping the ends
