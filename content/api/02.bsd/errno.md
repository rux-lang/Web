...
negates the result when [`IsError`](/api/bsd/iserror) reports one, and returns `0`
otherwise.
...
- [`IsError`](/api/bsd/iserror) - test whether a result is an error
- [`Syscall0`–`Syscall6`](/api/bsd/syscalls) - raw syscall entry points
