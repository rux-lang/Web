...
mapping with [`Munmap`](/api/bsd/munmap) using its correct base address and length.
::
...
- [`Types and constants`](/api/bsd/types) - protection and mapping flags
- [`Munmap`](/api/bsd/munmap) - remove a mapping
