...
[`ParseInt64`](/api/format/parseint64) and [`ParseFloat64`](/api/format/parsefloat64) return. The
[`TryParse`](/api/format/tryparseint64) functions collapse it to a `bool`, so it only
...
- [`ParseInt64`](/api/format/parseint64) / [`ParseFloat64`](/api/format/parsefloat64) — the functions that return it
