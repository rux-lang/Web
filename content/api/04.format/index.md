...
The package converts between values and text — a [`ToString`](/api/format/tostring) for every primitive type, a [`Stringable`](/api/format/stringable) interface for the types you write yourself, a family of [`Write`](/api/format/writeint) functions that append into a builder instead of allocating, and a set of [`Parse`](/api/format/parseint64) functions that read a value back out of text.

**Package:** `Format`

**Source:** [github.com/rux-lang/Rux/tree/main/Packages/Format](https://github.com/rux-lang/Rux/tree/main/Packages/Format)

A conversion to text produces a [`Text::String`](/api/text/string), which is what this package is built on. The [`Parse`](/api/format/parseint64) functions go the other way, reading a value out of a `Slice<char8>` or a `String` and allocating nothing.
...
| -------------------------------------- | ------------------------------------------------------- |
| [`Stringable`](/api/format/stringable) | What a type implements to convert itself to a `String`. |

## Errors

| Type                                   | Description                                                    |
| -------------------------------------- | -------------------------------------------------------------- |
| [`ParseError`](/api/format/parseerror) | Why a parse failed: empty input, an invalid byte, or overflow. |
...
| ---------------------------------- | --------------------------------------------------- |
| [`ToString`](/api/format/tostring) | The text of a value, in a `String` the caller owns. |
...
| Function                               | Description                                 |
| -------------------------------------- | ------------------------------------------- |
| [`WriteInt`](/api/format/writeint)     | The decimal digits of a signed integer.     |
| [`WriteUint`](/api/format/writeuint)   | The decimal digits of an unsigned integer.  |
| [`WriteFloat`](/api/format/writefloat) | The decimal text of a floating-point value. |
| [`WriteBool`](/api/format/writebool)   | `true` or `false`.                          |
| [`WriteChar`](/api/format/writechar)   | The UTF-8 bytes of a character.             |

### Classification

| Function                               | Description                                   |
| -------------------------------------- | --------------------------------------------- |
| [`IsNan`](/api/format/isnan)           | Whether a value is a NaN.                     |
| [`IsInfinite`](/api/format/isinfinite) | Whether a value is one of the two infinities. |
| [`IsFinite`](/api/format/isfinite)     | Whether a value is an ordinary number.        |
...
| Function                                         | Description                                         |
| ------------------------------------------------ | --------------------------------------------------- |
| [`ParseInt64`](/api/format/parseint64)           | Parse a signed integer, as a `Result`.              |
| [`ParseFloat64`](/api/format/parsefloat64)       | Parse a floating-point value, as a `Result`.        |
| [`TryParseInt64`](/api/format/tryparseint64)     | Parse a signed integer into an out-parameter.       |
| [`TryParseFloat64`](/api/format/tryparsefloat64) | Parse a floating-point value into an out-parameter. |
