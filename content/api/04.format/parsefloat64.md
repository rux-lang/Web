...
- [`TryParseFloat64`](/api/format/tryparsefloat64) — the same parse, into an out-parameter, without a `Result`
- [`ParseInt64`](/api/format/parseint64) — parse a signed integer instead
