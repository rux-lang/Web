...
This is the same parse as [`ParseFloat64`](/api/format/parsefloat64) — the same grammar and
...
- [`ParseFloat64`](/api/format/parsefloat64) — the same parse, returning a `Result` with the reason for a failure
- [`TryParseInt64`](/api/format/tryparseint64) — the integer counterpart
