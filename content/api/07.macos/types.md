...
Filled by [`GetTimeOfDay`](/api/macos/gettimeofday).

## See also

- [`MacOS`](/api/macos) — the package overview
- [`Mmap`](/api/macos/mmap) — uses the protection and mapping flags
- [`Syscall0`–`Syscall6`](/api/macos/syscalls) — use the class-qualified syscall numbers
