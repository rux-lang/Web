...
| --------------------------- | ---------------------------------- |
| [`Read`](/api/macos/read)   | Read bytes from a file descriptor. |
| [`Write`](/api/macos/write) | Write bytes to a file descriptor.  |
| [`Close`](/api/macos/close) | Close a file descriptor.           |

### Memory

| Function                      | Description                      |
| ----------------------------- | -------------------------------- |
| [`Mmap`](/api/macos/mmap)     | Create a virtual-memory mapping. |
| [`Munmap`](/api/macos/munmap) | Remove a virtual-memory mapping. |

### Process

| Function                      | Description                        |
| ----------------------------- | ---------------------------------- |
| [`Exit`](/api/macos/exit)     | Terminate the process immediately. |
| [`GetPid`](/api/macos/getpid) | Return the calling process ID.     |

### Time

| Function                                  | Description                       |
| ----------------------------------------- | --------------------------------- |
| [`GetTimeOfDay`](/api/macos/gettimeofday) | Read the current wall-clock time. |

### Raw syscalls

| Function                                     | Description                                |
| -------------------------------------------- | ------------------------------------------ |
| [`Syscall0`–`Syscall6`](/api/macos/syscalls) | Invoke an arbitrary syscall by number.     |
| [`IsError`](/api/macos/iserror)              | Test whether a result is a negative errno. |
| [`Errno`](/api/macos/errno)                  | Extract the positive errno from a result.  |

## Types and constants

The standard descriptors, class-qualified syscall numbers, mapping and protection flags, and the [`Timeval`](/api/macos/types) structure are listed on the [types and constants](/api/macos/types) page.
