...
negates the result when [`IsError`](/api/macos/iserror) reports one, and returns `0`
otherwise.
...
- [`IsError`](/api/macos/iserror) - test whether a result is an error
- [`Syscall0`–`Syscall6`](/api/macos/syscalls) - raw syscall entry points
