...
| Field         | Presence                              | Contract                                                         |
| ------------- | ------------------------------------- | ---------------------------------------------------------------- |
| `Namespace`   | Optional locally, required to publish | One [identity segment](/packaging/namespaces)                    |
| `Name`        | Required                              | One identity segment                                             |
| `Version`     | Required                              | Strict [Semantic Version](/packaging/versioning), no leading `v` |
...
[`Type`](/packaging/types) decides what the package produces and which commands accept it. `Authors`
...
| Form     | Requires               | Notes                                                 |
| -------- | ---------------------- | ----------------------------------------------------- |
| Registry | `Namespace`, `Version` | Resolved from the [registry](/packaging/registry)     |
...
machine. See [Dependencies](/packaging/dependencies) for the full requirement syntax.
::
...
[compile-time configuration](/docs/comptime/context) through `#config`, and overridable per build with
`--define NAME[=VALUE]`.
...
| **Publication** | [`pack`](/cli/pack), [`publish`](/cli/publish) | Package manifests only; `Namespace` and `MinRux` required; path dependencies rejected         |
