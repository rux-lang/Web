...
Unsuffixed floating-point literals default to [`float64`](/docs/floating/float64); request `float32` with the `f32` suffix or an annotation. Decimal and scientific forms (`6.022e23`) are both accepted — see [Literals](/docs/lexical/literals).
...
- [`float16`](/docs/floating/float16) — narrower half-precision alternative
