...
Unsuffixed floating-point literals default to [`float64`](/docs/floating/float64); request `float128` with the `f128` suffix or an annotation. Decimal and scientific forms (`1.2e4932`) are both accepted — see [Literals](/docs/lexical/literals).
...
- [`float256`](/docs/floating/float256) — the next precision up
