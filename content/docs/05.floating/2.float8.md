...
Unsuffixed floating-point literals default to [`float64`](/docs/floating/float64); request `float8` with the `f8` suffix or an annotation. Decimal and scientific forms (`6.0e1`) are both accepted — see [Literals](/docs/lexical/literals).
...
- [`float16`](/docs/floating/float16) — the next precision up
