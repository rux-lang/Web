...
Unsuffixed floating-point literals default to [`float64`](/docs/floating/float64); request `float256` with the `f256` suffix or an annotation. Decimal and scientific forms (`1.6e78913`) are both accepted — see [Literals](/docs/lexical/literals).
...
- [`float512`](/docs/floating/float512) — the maximum-precision float
