...
Unsuffixed floating-point literals otherwise default to [`float64`](/docs/floating/float64). See [Literals](/docs/lexical/literals) for the full grammar.
...
- [`float256`](/docs/floating/float256) — the next precision down
