...
`#Abi` is most useful on declarations that cross a language boundary — [`extern`](/docs/lang/ffi/extern) functions and [`asm func`](/docs/lang/functions/assembler) bodies — where the ABI must match exactly what the other side expects:
...
- [Assembler Functions](/docs/lang/functions/assembler) — where a fixed ABI matters most
- [`extern` Declarations](/docs/lang/ffi/extern) — foreign functions that follow a C ABI
- [Attributes](/docs/lang/attributes/overview) — the full attribute set
