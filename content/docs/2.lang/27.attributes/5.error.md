...
Pair `#Error` with [conditional compilation](/docs/lang/comptime/conditional) so a platform that lacks an implementation fails at the call site rather than at link time:
...
- [`#Warn`](/docs/lang/attributes/warn) — flag usage without breaking the build
- [Conditional Compilation](/docs/lang/comptime/conditional) — selecting per-platform implementations
