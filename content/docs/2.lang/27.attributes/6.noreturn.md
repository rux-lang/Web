...
It is the right annotation for process-exit routines, panic/abort handlers, and infinite event loops. The standard library's [`Panic`](/docs/api/core/panic) is declared this way.

## See Also

- [`Panic`](/docs/api/core/panic) — the standard-library function that uses this attribute
- [Functions](/docs/lang/functions/overview) — declarations and return types
