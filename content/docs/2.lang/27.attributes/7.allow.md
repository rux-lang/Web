...
| Rule          | Checks                                                                   |
| ------------- | ------------------------------------------------------------------------ |
| `naming.type` | Types use PascalCase (see [Identifiers](/docs/lang/lexical/identifiers)) |
...
- [Identifiers](/docs/lang/lexical/identifiers) — the naming conventions the linter enforces
