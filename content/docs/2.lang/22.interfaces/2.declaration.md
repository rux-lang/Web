...
- [Interface Implementation](/docs/lang/interfaces/implementation) — satisfying these signatures with `extend`
- [Methods](/docs/lang/structs/methods) — how `self` works in a method
