...
- [Interface Declaration](/docs/lang/interfaces/declaration) — the signatures an `extend` block must satisfy
- [Methods](/docs/lang/structs/methods) — the `extend` block and method syntax
- [Structures](/docs/lang/structs/overview) — the types being extended
