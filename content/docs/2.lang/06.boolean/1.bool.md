...
| Property | Value                                                          |
| -------- | -------------------------------------------------------------- |
| Alias of | [`bool8`](/docs/lang/boolean/bool8)                            |
...
`bool` behaves identically to [`bool8`](/docs/lang/boolean/bool8) in every respect — logical and bitwise operators, equality, and the explicit conversion rules to and from integers. See the [`bool8`](/docs/lang/boolean/bool8) page for the full reference.
...
- [`bool8`](/docs/lang/boolean/bool8) — the aliased type: full operator and conversion rules
- [`bool16`](/docs/lang/boolean/bool16) — the next width up
