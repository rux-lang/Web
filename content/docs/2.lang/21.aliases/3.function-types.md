...
These types tend to be long and appear repeatedly wherever callbacks are passed around, which makes them the prime candidate for a [type alias](/docs/lang/aliases/overview):
...
Any function whose signature matches the alias can be passed by name — the alias is [transparent](/docs/lang/aliases/overview#transparency), so no cast is involved:
...
- [Function Declaration](/docs/lang/functions/declaration) — how the functions you pass are written
