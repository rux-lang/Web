...
Unsuffixed floating-point literals otherwise default to [`float64`](/docs/lang/floating/float64). See [Literals](/docs/lang/lexical/literals) for the full grammar.
...
- [`float256`](/docs/lang/floating/float256) — the next precision down
