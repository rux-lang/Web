...
Unsuffixed floating-point literals default to [`float64`](/docs/lang/floating/float64); request `float16` with the `f16` suffix or an annotation. Decimal and scientific forms (`6.5e4`) are both accepted — see [Literals](/docs/lang/lexical/literals).
...
- [`float32`](/docs/lang/floating/float32) — the next precision up
