...
Unsuffixed floating-point literals default to [`float64`](/docs/lang/floating/float64); request `float8` with the `f8` suffix or an annotation. Decimal and scientific forms (`6.0e1`) are both accepted — see [Literals](/docs/lang/lexical/literals).
...
- [`float16`](/docs/lang/floating/float16) — the next precision up
