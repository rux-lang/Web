...
| Property          | Value                                    |
| ----------------- | ---------------------------------------- |
| Alias of          | [`float64`](/docs/lang/floating/float64) |
...
`float` behaves identically to [`float64`](/docs/lang/floating/float64) in every respect — operators, `NaN` and `Inf` rules, rounding, and conversion. See the [`float64`](/docs/lang/floating/float64) page for the full reference.

## See Also

- [`float64`](/docs/lang/floating/float64) — the aliased type: full arithmetic, comparison, and conversion rules
- [`float32`](/docs/lang/floating/float32) — narrower, hardware-native single precision
