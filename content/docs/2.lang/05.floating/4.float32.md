...
Unsuffixed floating-point literals default to [`float64`](/docs/lang/floating/float64); request `float32` with the `f32` suffix or an annotation. Decimal and scientific forms (`6.022e23`) are both accepted — see [Literals](/docs/lang/lexical/literals).
...
- [`float16`](/docs/lang/floating/float16) — narrower half-precision alternative
