...
By convention, constant names use **PascalCase** (see [Identifiers](/docs/lang/lexical/identifiers)).
...
| Topic                                                 | Description                                     |
| ----------------------------------------------------- | ----------------------------------------------- |
| [Intrinsic Constants](/docs/lang/constants/intrinsic) | Compiler-provided values such as `#source.line` |

## See Also

- [Immutable Variables (`let`)](/docs/lang/variables/let) — run-time immutable bindings
- [Intrinsic Constants](/docs/lang/constants/intrinsic) — compile-time `#source.file`, `#source.line`, and friends
- [Identifiers](/docs/lang/lexical/identifiers) — naming conventions for constants
