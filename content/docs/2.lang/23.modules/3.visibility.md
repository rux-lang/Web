...
Only `pub` items can be reached through a qualified path or brought in with [`import`](/docs/lang/modules/import).

## See Also

- [Module Declaration](/docs/lang/modules/declaration) — the namespaces `pub` exports from
- [Import](/docs/lang/modules/import) — consuming exported items
