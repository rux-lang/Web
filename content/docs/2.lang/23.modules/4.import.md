...
Only [`pub`](/docs/lang/modules/visibility) items can be imported; private items are not visible outside their module.

## See Also

- [Module Declaration](/docs/lang/modules/declaration) — defining the modules you import from
- [Items Visibility](/docs/lang/modules/visibility) — what `pub` exposes to importers
- [Conditional Compilation](/docs/lang/comptime/conditional) — platform-specific imports with `when`
