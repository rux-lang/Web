...
- [Function Declaration](/docs/lang/functions/declaration) — defining functions in general
- [Package Types](/docs/packaging/types) — executable vs. library packages
- [Fatal Errors](/docs/lang/error/fatal) — aborting with a non-zero exit code
