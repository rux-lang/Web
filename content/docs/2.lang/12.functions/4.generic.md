...
- [Function Declaration](/docs/lang/functions/declaration) — the non-generic form
- [Type Aliases](/docs/lang/aliases/overview) — naming the types a generic is instantiated with
