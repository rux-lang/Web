...
A `null` terminator is the conventional way to mark the end of a linked structure — see [Self-Referential Structures](/docs/lang/pointers/members#self-referential-structures).

## See Also

- [Pointers](/docs/lang/pointers/overview) — addresses and how a pointer is stored
- [Fields and Members](/docs/lang/pointers/members) — building linked structures that end in `null`
