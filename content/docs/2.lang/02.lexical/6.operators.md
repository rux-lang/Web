...
The address-of operand must be addressable — a variable, field, or slice element — not a temporary. See [Address-of and Dereference](/docs/lang/pointers/overview#address-of-and-dereference).
