...
If a literal value does not fit in `uint32`, the compiler emits an error at compile time. See [Literals](/docs/lang/lexical/literals) for decimal, hexadecimal, octal, and binary forms.
...
- [`int32`](/docs/lang/signed/int32) — signed counterpart of the same width
