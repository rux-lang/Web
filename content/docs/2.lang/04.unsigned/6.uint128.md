...
If a literal value does not fit in `uint128`, the compiler emits an error at compile time. See [Literals](/docs/lang/lexical/literals) for decimal, hexadecimal, octal, and binary forms.
...
- [`int128`](/docs/lang/signed/int128) — signed counterpart of the same width
