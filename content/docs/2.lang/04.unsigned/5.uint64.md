...
If a literal value does not fit in `uint64`, the compiler emits an error at compile time. See [Literals](/docs/lang/lexical/literals) for decimal, hexadecimal, octal, and binary forms.
...
- [`int64`](/docs/lang/signed/int64) — signed counterpart of the same width
