...
If a literal value does not fit in `uint16`, the compiler emits an error at compile time. See [Literals](/docs/lang/lexical/literals) for decimal, hexadecimal, octal, and binary forms.
...
- [`int16`](/docs/lang/signed/int16) — signed counterpart of the same width
