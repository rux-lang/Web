...
See [Floating-Point Types](/docs/lang/floating/float64#comparison) for the complete floating-point comparison rules.
...
- [Logical Operations](/docs/lang/operations/logical) — combining comparisons with `&&`, `||`, `!`
- [Arithmetic Operations](/docs/lang/operations/arithmetic) — producing the values being compared
- [Type Casts](/docs/lang/operations/type-cast) — matching operand types before comparing
