...
See [Floating-Point Types](/docs/lang/floating/float64#arithmetic) for precision, rounding, and special-value behavior.
...
- [Comparison Operations](/docs/lang/operations/comparison) — relating numeric results
- [Type Casts](/docs/lang/operations/type-cast) — converting between numeric types with `as`
- [Floating-Point Types](/docs/lang/floating/float64) — precision, rounding, and special values
