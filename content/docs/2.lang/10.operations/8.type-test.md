...
produces a [`bool`](/docs/lang/boolean/bool): `true` when the value has that type,
`false` otherwise.
...
[`as`](/docs/lang/lexical/operators#type-operators) cast.

## Testing Enum Variants

The most common use is checking which variant a tagged
[`enum`](/docs/lang/enums/overview) currently holds:
...
[logical operators](/docs/lang/operations/logical):
...
`is` is most often written directly in an [`if`](/docs/lang/statements/if)
...
handled, prefer [`match`](/docs/lang/statements/match): it destructures the variant
...
`is` and `as` are companion [type operators](/docs/lang/lexical/operators#type-operators):
...
See [Operator Precedence](/docs/lang/lexical/operators#operator-precedence) for the
complete table.

## See Also

- [Type Casts](/docs/lang/operations/type-cast) — the companion `as` operator
- [`match`](/docs/lang/statements/match) — exhaustive alternative when handling every variant
- [Enumerations](/docs/lang/enums/overview) — the tagged values `is` most often inspects
