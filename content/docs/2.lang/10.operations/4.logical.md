...
Use bitwise operators for masks and packed flags. See [Bitwise Operations](/docs/lang/operations/bitwise) for `&`, `|`, `^`, and `~`, and [Shift Operations](/docs/lang/operations/shift) for related bit manipulation.
...
- [Comparison Operations](/docs/lang/operations/comparison) — producing the boolean operands
- [Bitwise Operations](/docs/lang/operations/bitwise) — the non-short-circuiting `&`, `|`, `^`, `~`
- [Boolean Types](/docs/lang/boolean/bool) — the `bool` type these operators consume and produce
