...
It is the right annotation for process-exit routines, panic/abort handlers, and infinite event loops. The standard library's [`Panic`](/api/rux/panic) is declared this way.

## See Also

- [`Panic`](/api/rux/panic) — the standard-library function that uses this attribute
