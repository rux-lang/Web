...
The comparison is byte for byte and case-sensitive, on the same terms as [`StartsWith`](/docs/api/text/string/startswith).
...
- [`StartsWith`](/docs/api/text/string/startswith) — the same test at the other end
- [`Contains`](/docs/api/text/string/contains) — look for the bytes anywhere
