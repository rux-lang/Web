...
- [`TryParseInt64`](/docs/api/format/tryparseint64) — the same parse, into an out-parameter, without a `Result`
- [`ParseFloat64`](/docs/api/format/parsefloat64) — parse a floating-point value instead
- [`ParseError`](/docs/api/format/parseerror) — the reason a parse failed
- [`ToString`](/docs/api/format/tostring) — the inverse, a value to its text
