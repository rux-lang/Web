...
::warning
Do not use the return value as a length until [`IsError`](/docs/api/linux/iserror) has ruled out
a negative result.
::
...
- [`Write`](/docs/api/linux/write) — write bytes to a descriptor
- [`Close`](/docs/api/linux/close) — close a descriptor
