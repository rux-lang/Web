...
`int64` — the raw kernel result. Use [`IsError`](/docs/api/linux/iserror) before interpreting
...
- [`Constants`](/docs/api/linux/types) — exported syscall numbers
- [`IsError`](/docs/api/linux/iserror) — test the raw result
- [`Errno`](/docs/api/linux/errno) — decode an error result
