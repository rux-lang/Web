...
mapping with [`Munmap`](/docs/api/bsd/munmap) using its correct base address and length.
::
...
- [`Types and constants`](/docs/api/bsd/types) - protection and mapping flags
- [`Munmap`](/docs/api/bsd/munmap) - remove a mapping
