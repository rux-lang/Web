...
constants with [`ClockGetTime`](/docs/api/bsd/clockgettime).
...
Used by [`Nanosleep`](/docs/api/bsd/nanosleep) and [`ClockGetTime`](/docs/api/bsd/clockgettime).

## See also

- [`Bsd`](/docs/api/bsd) — the package overview
- [`Mmap`](/docs/api/bsd/mmap) — uses the protection and mapping flags
- [`ClockGetTime`](/docs/api/bsd/clockgettime) — uses the clock IDs and `Timespec`
- [`Syscall0`–`Syscall6`](/docs/api/bsd/syscalls) — use the syscall numbers directly
