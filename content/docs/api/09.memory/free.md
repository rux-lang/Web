...
| ----- | --------- | ---------------------------------------------------------------------------------------- |
| `ptr` | `*opaque` | A block from [`Alloc`](/docs/api/memory/alloc) or [`Realloc`](/docs/api/memory/realloc). |
...
block twice, releasing a pointer that [`Realloc`](/docs/api/memory/realloc) has already moved, or
...
- [`Realloc`](/docs/api/memory/realloc) — resize a block instead of releasing it
