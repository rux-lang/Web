...
- [`Tan`](/docs/api/math/tan) — the function `ArcTan` inverts
- [`ArcSin`](/docs/api/math/arcsin) / [`ArcCos`](/docs/api/math/arccos) — the other inverse trigonometric functions
- [`ArcCot`](/docs/api/math/arccot) — `HalfPi - ArcTan(x)`
