...
- [`Sin`](/docs/api/math/sin) / [`Cos`](/docs/api/math/cos) — sine and cosine
- [`Cotan`](/docs/api/math/cotan) — the reciprocal function, computed directly rather than as `1 / Tan(x)`
- [`ArcTan`](/docs/api/math/arctan) — the inverse of `Tan`
