...
**Microsoft documentation:** [`WideCharToMultiByte`](https://learn.microsoft.com/en-us/windows/win32/docs/api/stringapiset/nf-stringapiset-widechartomultibyte)
...
- [`MultiByteToWideChar`](/docs/api/windows/multibytetowidechar) — convert to UTF-16
