...
**Microsoft documentation:** [`GetProcAddress`](https://learn.microsoft.com/en-us/windows/win32/docs/api/libloaderapi/nf-libloaderapi-getprocaddress)
...
- [`FreeLibrary`](/docs/api/windows/freelibrary) — release a module reference
