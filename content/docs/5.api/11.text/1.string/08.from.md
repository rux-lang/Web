...
The result has to be released with [`Free`](/docs/api/text/string/free).
...
- [`New`](/docs/api/text/string/new) — the empty string, without a copy
- [`Clone`](/docs/api/text/string/clone) — copy a `String` rather than a buffer
- [`Free`](/docs/api/text/string/free) — release the block when the string is finished with
