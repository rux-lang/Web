...
- [`IndexOf`](/docs/api/text/string/indexof) — find the offset to copy from
- [`At`](/docs/api/text/string/at) — read one byte instead of copying a range
- [`Trim`](/docs/api/text/string/trim) — the common case of dropping the ends
