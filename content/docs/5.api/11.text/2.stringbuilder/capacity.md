...
Capacity only ever grows on its own — [`Clear`](/docs/api/text/stringbuilder/clear) keeps it, and [`Shrink`](/docs/api/text/stringbuilder/shrink) is what hands it back.
...
- [`Length`](/docs/api/text/stringbuilder/length) — how much of the capacity is used
- [`Reserve`](/docs/api/text/stringbuilder/reserve) — ask for more room up front
- [`Shrink`](/docs/api/text/stringbuilder/shrink) — hand back what is unused
