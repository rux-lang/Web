...
Filled by [`GetTimeOfDay`](/docs/api/macos/gettimeofday).

## See also

- [`MacOS`](/docs/api/macos) — the package overview
- [`Mmap`](/docs/api/macos/mmap) — uses the protection and mapping flags
- [`Syscall0`–`Syscall6`](/docs/api/macos/syscalls) — use the class-qualified syscall numbers
