...
negates the result when [`IsError`](/docs/api/macos/iserror) reports one, and returns `0`
otherwise.
...
- [`IsError`](/docs/api/macos/iserror) - test whether a result is an error
- [`Syscall0`–`Syscall6`](/docs/api/macos/syscalls) - raw syscall entry points
