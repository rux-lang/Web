...
this wrapper leaves it null and fills only the [`Timeval`](/docs/api/macos/types) with seconds
...
- [`Types and constants`](/docs/api/macos/types) - the `Timeval` structure
