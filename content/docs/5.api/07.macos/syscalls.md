...
or resource management is performed. Use [`IsError`](/docs/api/macos/iserror) and
[`Errno`](/docs/api/macos/errno) to interpret it.
...
| ------------------------------------ | ------------------------------------------------------ |
| [`Errno`](/docs/api/macos/errno)     | Return the positive errno of a failing result, else 0. |
| [`IsError`](/docs/api/macos/iserror) | Test whether a result is a negative errno.             |

## See also

- [`MacOS`](/docs/api/macos) — the package overview
- [`Types and constants`](/docs/api/macos/types) - class-qualified syscall numbers
