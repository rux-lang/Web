...
- [`Cbrt`](/docs/api/math/cbrt) — cube root, defined for negative arguments
- [`Pow`](/docs/api/math/pow) — general exponentiation
- [`Hypot`](/docs/api/math/hypot) — √(x² + y²) without overflow
