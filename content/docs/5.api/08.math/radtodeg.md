...
- [`DegToRad`](/docs/api/math/degtorad) — the inverse conversion
- [`Sin`](/docs/api/math/sin) / [`Cos`](/docs/api/math/cos) / [`Tan`](/docs/api/math/tan) — trigonometric functions that return radians
