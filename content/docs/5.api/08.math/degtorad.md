...
- [`RadToDeg`](/docs/api/math/radtodeg) — the inverse conversion
- [`Sin`](/docs/api/math/sin) / [`Cos`](/docs/api/math/cos) / [`Tan`](/docs/api/math/tan) — trigonometric functions that expect radians
