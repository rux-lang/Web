...
or resource management is performed. Use [`IsError`](/docs/api/bsd/iserror) and
[`Errno`](/docs/api/bsd/errno) to interpret it.
...
| ---------------------------------- | ------------------------------------------------------ |
| [`Errno`](/docs/api/bsd/errno)     | Return the positive errno of a failing result, else 0. |
| [`IsError`](/docs/api/bsd/iserror) | Test whether a result is a negative errno.             |

## See also

- [`Bsd`](/docs/api/bsd) — the package overview
- [`Types and constants`](/docs/api/bsd/types) - shared syscall numbers
