...
negates the result when [`IsError`](/docs/api/bsd/iserror) reports one, and returns `0`
otherwise.
...
- [`IsError`](/docs/api/bsd/iserror) - test whether a result is an error
- [`Syscall0`–`Syscall6`](/docs/api/bsd/syscalls) - raw syscall entry points
