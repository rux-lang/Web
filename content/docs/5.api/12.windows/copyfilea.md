...
**Microsoft documentation:** [`CopyFileA`](https://learn.microsoft.com/en-us/windows/win32/docs/api/winbase/nf-winbase-copyfilea)
...
- [`MoveFileA`](/docs/api/windows/movefilea) — move or rename
