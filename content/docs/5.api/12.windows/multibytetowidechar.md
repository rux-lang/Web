...
**Microsoft documentation:** [`MultiByteToWideChar`](https://learn.microsoft.com/en-us/windows/win32/docs/api/stringapiset/nf-stringapiset-multibytetowidechar)
...
- [`WideCharToMultiByte`](/docs/api/windows/widechartomultibyte) — convert from UTF-16
