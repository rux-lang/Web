...
**Microsoft documentation:** [`WriteFile`](https://learn.microsoft.com/en-us/windows/win32/docs/api/fileapi/nf-fileapi-writefile)
...
- [`ReadFile`](/docs/api/windows/readfile) — read bytes
