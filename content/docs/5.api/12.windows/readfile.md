...
**Microsoft documentation:** [`ReadFile`](https://learn.microsoft.com/en-us/windows/win32/docs/api/fileapi/nf-fileapi-readfile)
...
- [`WriteFile`](/docs/api/windows/writefile) — write bytes
