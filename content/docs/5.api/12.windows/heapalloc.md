...
**Microsoft documentation:** [`HeapAlloc`](https://learn.microsoft.com/en-us/windows/win32/docs/api/heapapi/nf-heapapi-heapalloc)
...
[`HeapFree`](/docs/api/windows/heapfree) using the same heap.
