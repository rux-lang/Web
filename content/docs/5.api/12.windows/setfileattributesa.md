...
**Microsoft documentation:** [`SetFileAttributesA`](https://learn.microsoft.com/en-us/windows/win32/docs/api/fileapi/nf-fileapi-setfileattributesa)
...
- [`GetFileAttributesA`](/docs/api/windows/getfileattributesa) — retrieve attributes
