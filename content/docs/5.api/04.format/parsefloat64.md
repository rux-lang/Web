...
- [`TryParseFloat64`](/docs/api/format/tryparsefloat64) — the same parse, into an out-parameter, without a `Result`
- [`ParseInt64`](/docs/api/format/parseint64) — parse a signed integer instead
