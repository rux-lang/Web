...
| `Type`        | string           | ❌       | [Package type](/docs/packages/types) (defaults to `"Program"`) |
...
See [Dependencies](/docs/packages/dependencies) for adding, installing, and updating packages.
