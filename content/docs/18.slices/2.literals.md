...
Because a string _is_ a `Slice<char8>`, it supports the same [indexing and iteration](/docs/slices/access) as any other slice, and it can be passed to any function that takes a `Slice<char8>`.
