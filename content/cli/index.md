...
| Option                                                              | Description              |
| ------------------------------------------------------------------- | ------------------------ |
| [`--color`](/cli/global#color-autoonoff)                            | Control colored output   |
| [`-h`](/cli/global#h-help), [`--help`](/cli/global#h-help)          | Show help information    |
| [`-q`](/cli/global#q-quiet), [`--quiet`](/cli/global#q-quiet)       | Do not show log messages |
| [`-v`](/cli/global#v-verbose), [`--verbose`](/cli/global#v-verbose) | Use verbose output       |
| [`-V`](/cli/global#v-version), [`--version`](/cli/global#v-version) | Show version information |
