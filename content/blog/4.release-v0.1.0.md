...
date: 2026-04-30
category: Release
image: /images/blog/v0.1.0.png
authors:
  - name: Ivan Muzyka
    avatar:
      src: https://avatars.githubusercontent.com/u/4063473?v=4
    to: https://x.com/musicvano
seo:
  title: Rux 0.1.0 — It Compiles!
  description: The first Rux compiler release is here. Install it on Windows via Scoop, set up VS Code, and run your first program.
  ogImage: https://rux-lang.dev/images/blog/v0.1.0.png
  ogType: article
  ogUrl: https://rux-lang.dev/blog/release-v0.1.0
---
...
Full installation guide: [Installation on Windows](/docs/start/install/windows).
...
Full setup guide: [Visual Studio Code](/docs/start/editors/vscode).
...
Follow the project on [GitHub](https://github.com/rux-lang/Rux/releases), join the community on [Discord](https://discord.com/invite/uvSHjtZSVG), keep an eye on the [changelog](https://github.com/rux-lang/Rux/blob/main/CHANGELOG.md), and stay tuned.
