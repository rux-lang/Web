...
seo:
  title: Programming Language Without LLVM
  description: Rux is a new systems programming language built from scratch without LLVM, featuring a custom compiler pipeline, object format, linker, and package manager.
  ogImage: https://rux-lang.dev/images/og-blog.png
  ogType: article
  ogUrl: https://rux-lang.dev/blog/language-without-llvm
---
...
```sh
rux new <name> [--executable | --shared | --static | --source]   # scaffold a new package
